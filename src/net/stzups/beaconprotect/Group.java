...
public class Group {
    ...
    public void addMember(OfflinePlayer player) {
        members.put(player, PlayerRole.DEFAULT);
    }
    ...
    public void setRole(Player player, PlayerRole newRole) {
        members.put(player, newRole);
    }
