...
public class BlockDurability {
    ...
    boolean changeDurability(BeaconProtect plugin, Player player, int changeDurability, boolean setDurability, boolean useBeaconDurability) {
        ...
        if (beaconDurability == -69) {
            beaconDurability = CustomBeacons.getMaxDurability(block.getLocation(), plugin.beacons) * this.setDurability;
            maxBeaconDurability = beaconDurability;
        }//initializer value
    ...
    public int getMaxBeaconDurability() {
        return maxBeaconDurability;
    }
    ...
    public int getBeaconDurability() {
