                ...
                if(args[0].equalsIgnoreCase(key)){
                    if(args[1].equalsIgnoreCase("addMember")){
                        ...
                        try{
                            ...
                            sender.sendMessage("Set "+args[2]+" as owner of "+key);
                        }catch(Exception e){
                            System.out.println(e);
                            sender.sendMessage("Could not find player by the name of "+args[2]);
                        }
                        ...
                        sender.sendMessage("Set description of "+key);
                    }else if(args[1].equalsIgnoreCase("setName")){
                        plugin.groups.get(key).setName(plugin, args[2]);
                        sender.sendMessage("Changed name of group from ");
                    }else{
                        return false;
                    }
                    return true;
